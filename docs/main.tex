...
% título
\title{Sistema de interações sociais baseadas em similaridade}
...
\include{3-metodologia/texto}		% metodologia
\include{4-produto/texto}		% produto final
%\include{5-valida/texto}		% experimentação e validação
\include{5-conclusao/texto}		% conclusão
